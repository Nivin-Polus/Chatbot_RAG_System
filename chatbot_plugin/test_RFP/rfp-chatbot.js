        ...
        <div class="policy-section active">
            ...
            <div class="policy-content">
                <div class="policy-card">
                    ...
                    <p>Sorry, we couldn't find any RFP information matching "<strong>${escapeHtml(query)}</strong>".</p>
                    <p>Try searching with different keywords or browse the RFP categories in the sidebar.</p>
                </div>
            </div>
        </div>
    `;
